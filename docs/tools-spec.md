...
Tools — це функції, які агент може викликати для взаємодії зі зовнішнім світом: файлова система, веб-пошук. Claude бачить опис кожного tool і самостійно вирішує коли і в якій послідовності їх використовувати.
